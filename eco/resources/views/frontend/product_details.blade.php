                            ...
                            <div class="product_details_image">
                                <div class="details_image_carousel">
                                    ...
                                    <div class="slider_item">
                                        <img src="{{ asset('uploads/product/thumbnails') }}/{{ $thumbnail->thumbnails }}" alt="image_not_found">
                                    </div>
                                    @endforeach
                                ...
                                <div class="product-area clearfix">
                                    ...
                                    <div class="grid">
                                        ...
                                        <div class="details">
                                            ...
                                            <p><a href="{{ route('product.details', $related->slug ) }}">{{ $related->short_description }} </a></p>
                                            <div class="rating">
