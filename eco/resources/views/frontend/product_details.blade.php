                ...
                <div class="col col-lg-6">
                    <div class="product_details_image">
                        <div class="details_image_carousel">
                            ...
                            @endphp
                            @foreach (App\Models\Thumbnails::where('product_id', $product_id)->get() as $thumbnail)
                                <div class="slider_item">
                                    <img src="{{ asset('uploads/product/thumbnails') }}/{{ $thumbnail->thumbnails }}"
                                        alt="image_not_found">
                                </div>
                            @endforeach
                ...
                <div class="col-lg-6">
                    <div class="product_details_content">
                                    ...
                                    <div class="col col-md-6">
                                        <div class="select_option clearfix">
                                            ...
                                            <select class="form-control" name="color_id" id="color_id">
                                                ...
                                                @foreach ($availavle_colors as $colors)
                        ...
                        <div class="quantity_wrap">
                            ...
                            <div class="total_price">Total: BDT <span
                        ...
                        @if (session('stock'))
                            <span class="alert alert-info d-block">{{ session('stock') }} </span>
                        @endif
                    </div>
                    </form>
                </div>
            ...
            <div class="details_information_tab">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="description_tab" role="tabpanel">
                        <p>{!! $product_details->first()->long_description !!}
                        </p>
                    </div>
                            ...
                            @foreach ($related_product as $related)
                                <div class="grid">
                                    <div class="product-pic">
                                        <img src="{{ asset('uploads/product') }}/{{ $related->preview_image }}" alt>
                                        <div class="actions">
                                            <ul>
                                                <li>
                                    ...
                                    <div class="details">
                                        ...
                                        <p><a href="{{ route('product.details', $related->slug) }}">{{ $related->short_description }}
                                            </a></p>
                                        <div class="rating">
