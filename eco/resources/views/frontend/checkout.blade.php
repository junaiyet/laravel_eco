                     ...
                     <div class="coll-1">
                        <div class="woocommerce-billing-fields">
                           ...
                           <p class="form-row form-row form-row-first validate-required" id="billing_first_name_field">
                              <label for="name" class="">First Name <abbr class="required" title="required">*</abbr></label>
                  ...
                  <div id="order_review" class="woocommerce-checkout-review-order">
                    ...
                    <table class="shop_table woocommerce-checkout-review-order-table">
                           <tr class="cart-subtotal">
                              ...
                              <td><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">BDT </span>{{ $sub_total }}</span>
                              </td>
                           </tr>
                           <tr class="cart-subtotal">
                              <th>Discount</th>
                        ...
                        <br>
                                  <input type="radio" class="charge" name="charge" value="100">Outside Dhaka
                              </td>
                           </tr>
