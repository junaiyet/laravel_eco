    ...
    <div class="body_wrap">
        ...
        <main>
            ...
            <div class="sidebar-menu-wrapper">
                    ...
                    @endphp
                        ...
                        <li>
                            <div class="item_image">
                                <img src="{{asset('uploads/product')}}/{{ $cart->rel_to_product->preview_image }}" alt="image_not_found">
                            </div>
                            <div class="item_content">
                               ...
                               <p> <span >Color: {{ $cart->rel_tol_color->color_name }}</span> | <span >Size: {{ $cart->rel_tol_size->size_name }} </span></p>
                            </div>
                ...
                @empty
                <div class="alert alert-info"><strong>You have not added any product yet !!!</strong></div>
                     @endforelse
                    </ul>
