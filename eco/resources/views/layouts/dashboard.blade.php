          ...
          <ul class="metismenu" id="menu">
            ...
            <li>
              ...
              <ul>
                ...
                <li> <a href="{{route('users')}}"><i class="bi bi-circle"></i>User List</a> </li>
            ...
            <li>
              ...
              <ul>
                ...
                <li> <a href="{{ route('category') }}"><i class="bi bi-circle"></i>Category list</a> </li>
            ...
            <li>
              ...
              <ul>
                ...
                <li> <a href="{{ route('subcategory') }}"><i class="bi bi-circle"></i>SubCategory List</a> </li>
            ...
            <li>
              ...
              <ul>
                ...
                <li> <a href="{{route('add.product')}}"><i class="bi bi-circle"></i>Add Product</a> </li>
                <li> <a href="{{route('product.view')}}"><i class="bi bi-circle"></i>View Product</a> </li>
                <li> <a href="{{route('variation')}}"><i class="bi bi-circle"></i>Product Variation</a> </li>
           ...
           <li>
              ...
              <ul>
                ...
                <li> <a href="{{route('add.coupon')}}"><i class="bi bi-circle"></i>Coupon</a> </li>
